...
AI Engineer & Consultant. I build AI agents and set up evals to make them reliable — been shipping AI apps since the GPT-3.5 Turbo days (Jan 2023). Ex-PM, so I get both the business and engineering side.

Community Dev at [Cursor](https://cursor.com) (user since 2023) and [LangChain Ambassador](https://www.langchain.com/community).

## Highlights

- Built a **Support Copilot** for a $10B+ startup — 80% resolution rate ([writeup](https://sanjeed.in/Building-a-Support-Copilot-for-a-Hypergrowth-Startup))
- Built an **AI Video Agent** — client went from stuck to 6-figure revenue ([writeup](https://sanjeed.in/Building-an-AI-Video-Agent))
- Built a **GenUI Agent** for enterprise retail — presented at NRF 2025 & 2026 ([writeup](https://sanjeed.in/Building-a-GenUI-AI-Agent-for-Enterprise))
- **[awesome-cursor-rules-mdc](https://github.com/sanjeed5/awesome-cursor-rules-mdc)** — 3300+ GitHub stars
- 240k+ LinkedIn impressions & 600k+ X impressions on AI content
- IIT Madras grad. First in my family to go to college.
...
![GitHub Contribution Graph](https://ghchart.rshah.org/sanjeed5)

## Writing

I write about AI engineering, evals, and building at **[sanjeed.in](https://sanjeed.in)**

- [How to become an AI PM — from an ex-PM turned AI Engineer](https://sanjeed.in/How-to-become-an-AI-PM---From-an-ex-PM-turned-AI-Engineer)
- [Sometimes You Discover Simple by Building Complex First](https://sanjeed.in/Sometimes-You-Discover-Simple-by-Building-Complex-First)
- [Using an Agent to Improve Another Agent](https://sanjeed.in/using-an-agent-to-improve-another-agent)
- [Cursor Fixed My Music Video](https://sanjeed.in/cursor-fixed-my-music-video)
- [Best Guides for Prompt Engineering](https://sanjeed.in/Best-Guides-for-Prompt-Engineering)
